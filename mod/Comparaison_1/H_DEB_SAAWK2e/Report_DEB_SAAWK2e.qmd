...
file_path <- here::here("mod/H_DEB_SAAWK2e")
...
Distrib (Alpha,        TruncNormal_cv,   2, 0.01,          1,       5);
Distrib (K,            TruncNormal_cv,   0.2, 0.01,     0.05,     5);
...
df_sim_long <- df_sim %>%
  ...
  mutate(Variable = fct_relevel(Variable, 
                                "Energy", "Size", "Weight", "Reproduction", "Maturity", "Organic_matter", "freal", "kapreal"))
