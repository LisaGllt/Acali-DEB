...
l_params_median <- c(
  # Environment
  muOM = 11700, rOM_ClxHorse = 0.007926,
  # Energy assimilation
  Fm = 0.002548, kapX = 0.258, K = 0.01746, pAm = 164.6, v = 0.2026, 
  kap  = 0.9297, kapA = 0.5105,
  # Maintenance and growth
  pM = 125.7, Eg = 4183, dv = 3.950, wE = 1.342e-9,         
  # Maturity
  kJ = 0.002793, Ehb = 0.5, Ehp = 95.11,
  # Reproduction
  E_coc = 30.28, kapR = 0.475,   
...
write.table(df_Sobol_param, file = paste0("mod/Correction_X/Z_AS/Param_sobol_", Sobol_type,".txt"), sep = "\t", row.names = FALSE, quote = FALSE)
